...
public class FraudDetectionService {
    ...
    public void checkTransaction(Map<String, Object> payload) {
        ...
        if (result.isFraud()) {
            ...
            log.info("Suspicious activity detected - account: {} " + "reason {} - requestions OTP verrification",
    ...
    private FraudCheckResult performFraudChecks(
        ...
        if (isVelocityExceeded(accountNumber)) {
            return new FraudCheckResult(
                    true,
                    "Too many transaction in 60 seconds " + "velocity limits exceeded"
            );
        }
    ...
    private boolean isBalanceCheckFailed(BigDecimal senderBalance, BigDecimal amount) {
        ...
        log.info("Balance check - amount: {} maxAllow: {} suspicious: {}",
